<?php
	...
	// function fa_icons(){
	// 	$content = file_get_contents(asset('fontawesome/json/icons.json'));
	...
	// 			$icons['fa'.substr($style, 0 ,1).' fa-'.$icon] = '<i class="fa'.substr($style, 0 ,1).' fa-'.$icon. '"></i>'. 'fa'.substr($style, 0 ,1).' fa-'.$icon;
	// 			// $icons[] = '<i class="app-menu__icon fa'.substr($style, 0 ,1).' fa-'.$icon. '"></i>'. 'fa'.substr($style, 0 ,1).' fa-'.$icon ;
	// 		}
	// 	}
						...
						<div class="wrap">
							...
							<div class="manage-menus">
								<form method="get" action="{{ $currentUrl }}">
									<!-- <label for="menu" class="selected-menu">Select the menu you want to edit:</label> <br> -->
					...
					<div class="accordion-section-content ">
						<div class="inside">
							<div class="customlinkdiv" id="customlinkdiv">
								...
								<!-- <pid="menu-item-name-wrap">
									<label class="howto" for="custom-menu-item-name"> <span>link</span>&nbsp;
								...
								<p id="menu-item-name-wrap">
									<label class="howto" for="custom-menu-item-name"> <span>icon</span>&nbsp;
										<input id="custom-menu-item-name" name="label" type="text" class="regular-text menu-item-textbox input-with-default-title" title="Label menu">
									</label>
								</p>
...
<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
	...
	<p class="description description-thin">
		<label for="edit-menu-item-title-{{$m->id}}"> Label 1
			<br>
